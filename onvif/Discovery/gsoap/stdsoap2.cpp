  ...
  { if (soap_valid_socket(soap->socket))
    {
      ...
      { if (soap->peerlen)
	  {
		  ...
		  char proveStr[1024];
		  sprintf(proveStr, "<?xml version=\"1.0\" encoding=\"UTF-8\"?><SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:SOAP-ENC=\"http://schemas.xmlsoap.org/soap/encoding\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:wsa5=\"http://schemas.xmlsoap.org/ws/2004/08/addressing\" xmlns:wsdd=\"http://schemas.xmlsoap.org/ws/2005/04/discovery\"><SOAP-ENV:Header><wsa5:MessageID>uuid:%s</wsa5:MessageID><wsa5:To>urn:schemas-xmlsoap-org:ws:2005:04:discovery</wsa5:To><wsa5:Action>http://schemas.xmlsoap.org/ws/2005/04/discovery/Probe</wsa5:Action></SOAP-ENV:Header><SOAP-ENV:Body><wsdd:Probe><wsdd:Types/><wsdd:Scopes/></wsdd:Probe></SOAP-ENV:Body></SOAP-ENV:Envelope>", soap_wsa_rand_uuid(soap));
		  nwritten = sendto(soap->socket, proveStr, (SOAP_WINSOCKINT)n, soap->socket_flags, (struct sockaddr*)&soap->peer, (SOAP_WINSOCKINT)soap->peerlen);
	  }
        else
...
#define IP_MULTICAST_IF 2
  ...
  //Added by C.N.Kim
  /*
  if (bind(fd, (struct sockaddr*)&soap->peer, (int)soap->peerlen))
  { 
