...
v4l2_device_solo6010_dkms::v4l2_device_solo6010_dkms(BC_DB_RES dbres)
...
v4l2_device_solo6010_dkms::~v4l2_device_solo6010_dkms()
{
	if (dev_fd >= 0) {
		close(dev_fd);
		dev_fd = -1;
...
int v4l2_device_solo6010_dkms::v4l2_bufs_prepare()
{
...
int v4l2_device_solo6010_dkms::start()
{
...
void v4l2_device_solo6010_dkms::stop()
{
	enum v4l2_buf_type type = V4L2_BUF_TYPE_VIDEO_CAPTURE;
...
void v4l2_device_solo6010_dkms::buf_return()
{
...
int v4l2_device_solo6010_dkms::read_packet()
{
	struct v4l2_buffer vb;
	buf_return();
	reset_vbuf(&vb);
...
int v4l2_device_solo6010_dkms::set_resolution(uint16_t width, uint16_t height,
		uint8_t interval)
{
	int re = 0;
...
int v4l2_device_solo6010_dkms::set_mjpeg()
{
...
int v4l2_device_solo6010_dkms::set_control(unsigned int ctrl, int val)
{
...
#if 0
void *v4l2_device_solo6010_dkms::buf_data()
{
	if (buf_idx < 0)
		return NULL;
...
unsigned int v4l2_device_solo6010_dkms::buf_size()
{
	if (buf_idx < 0)
		return 0;
...
int v4l2_device_solo6010_dkms::set_osd(const char *fmt, ...)
{
	char buf[256];
	va_list ap;
...
void v4l2_device_solo6010_dkms::update_properties()
{
...
int v4l2_device_solo6010_dkms::set_motion(bool on)
{
...
int v4l2_device_solo6010_dkms::set_motion_thresh_global(char value)
{
...
int v4l2_device_solo6010_dkms::set_motion_thresh(const char *map, size_t size)
{
	if (!(caps() & BC_CAM_CAP_V4L2_MOTION))
		return -ENOSYS;
...
void v4l2_device_solo6010_dkms::getStatusXml(pugi::xml_node& xmlnode)
{
}
