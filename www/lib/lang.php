...
define('VA_COMPRESSION', 'Compression level');
define('VA_COMPRESSION_LOW', 'Low');
...
define('AIP_ONVIF_RESOLUTION', 'Resolution ONVIF');
...
#storage
define('STORAGE_ESTIMATION', 'Storage Estimation');
...
#login
define('LOGIN_PLEASE', 'Please Sign In');
define('LOGIN_PASSWORD', 'Password');
define('LOGIN_LOGIN', 'Username');
