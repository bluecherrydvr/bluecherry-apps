...
define('LA_OK', 'Success code');
define('LA_FAIL', 'Failure code');
define('LA_EXPIRED', 'The license has expired or system time has been tampered with. Ensure your date and time settings are correct.');
define('LA_SUSPENDED', 'The license has been suspended');
define('LA_GRACE_PERIOD_OVER', 'The grace period for server sync is over.');
define('LA_TRIAL_EXPIRED', 'The local trial has expired or system time has been tampered with. Ensure your date and time settings are correct.');
define('LA_LOCAL_TRIAL_EXPIRED', 'he local trial has expired or system time has been tampered with. Ensure your date and time settings are correct.');
define('LA_RELEASE_UPDATE_AVAILABLE', 'A new update is available for the product. This means a new release has been published for the product.');
define('LA_RELEASE_NO_UPDATE_AVAILABLE', 'No new update is available for the product. The current version is latest.');
define('LA_E_FILE_PATH', 'Invalid file path.');
define('LA_E_PRODUCT_FILE', 'Invalid or corrupted product file.');
define('LA_E_PRODUCT_DATA', 'Invalid product data.');
define('LA_E_PRODUCT_ID', 'The product id is incorrect.');
define('LA_E_SYSTEM_PERMISSION', 'Insufficient system permissions. Occurs when LA_SYSTEM flag is used but application is not run with admin privileges.');
define('LA_E_FILE_PERMISSION', 'No permission to write to file.');
define('LA_E_WMIC', 'Fingerprint couldn\'t be generated.');
define('LA_E_TIME', 'The difference between the network time and the system time is more than allowed clock offset.');
define('LA_E_INET', 'Failed to connect to the server due to network error.');
define('LA_E_NET_PROXY', 'Invalid network proxy.');
define('LA_E_HOST_URL', 'Invalid Cryptlex host url.');
define('LA_E_BUFFER_SIZE', 'The buffer size was smaller than required.');
define('LA_E_APP_VERSION_LENGTH', 'App version length is more than 256 characters.');
define('LA_E_REVOKED', 'The license has been revoked.');
define('LA_E_LICENSE_KEY', 'Invalid license key.');
define('LA_E_LICENSE_TYPE', 'Invalid license type. Make sure floating license is not being used.');
define('LA_E_OFFLINE_RESPONSE_FILE', 'Invalid offline activation response file.');
define('LA_E_OFFLINE_RESPONSE_FILE_EXPIRED', 'The offline activation response has expired.');
define('LA_E_ACTIVATION_LIMIT', 'The license has reached it\'s allowed activations limit.');
define('LA_E_ACTIVATION_NOT_FOUND', 'The license activation was deleted on the server.');
define('LA_E_DEACTIVATION_LIMIT', 'The license has reached it\'s allowed deactivations limit.');
define('LA_E_TRIAL_NOT_ALLOWED', 'Trial not allowed for the product.');
define('LA_E_TRIAL_ACTIVATION_LIMIT', 'Your account has reached it\'s trial activations limit.');
define('LA_E_MACHINE_FINGERPRINT', 'Machine fingerprint has changed since activation.');
define('LA_E_METADATA_KEY_LENGTH', 'Metadata key length is more than 256 characters.');
define('LA_E_METADATA_VALUE_LENGTH', 'Metadata value length is more than 256 characters.');
define('LA_E_ACTIVATION_METADATA_LIMIT', 'The license has reached it\'s metadata fields limit');
define('LA_E_TRIAL_ACTIVATION_METADATA_LIMIT', 'The trial has reached it\'s metadata fields limit.');
define('LA_E_METADATA_KEY_NOT_FOUND', 'The metadata key does not exist.');
define('LA_E_TIME_MODIFIED', 'The system time has been tampered (backdated).');
define('LA_E_RELEASE_VERSION_FORMAT', 'Invalid version format.');
define('LA_E_AUTHENTICATION_FAILED', 'Incorrect email or password.');
define('LA_E_METER_ATTRIBUTE_NOT_FOUND', 'The meter attribute does not exist.');
define('LA_E_METER_ATTRIBUTE_USES_LIMIT_REACHED', 'The meter attribute has reached it\'s usage limit.');
define('LA_E_CUSTOM_FINGERPRINT_LENGTH', 'Custom device fingerprint length is less than 64 characters or more than 256 characters.');
define('LA_E_VM', 'Application is being run inside a virtual machine / hypervisor, and activation has been disallowed in the VM.');
define('LA_E_COUNTRY', 'Country is not allowed.');
define('LA_E_IP', 'IP address is not allowed.');
define('LA_E_RATE_LIMIT', 'Rate limit for API has reached, try again later.');
define('LA_E_SERVER', 'Server error.');
define('LA_E_CLIENT', 'Client error.');
