        ...
        <form action="/ptzpresetedit?id=<?php echo ((!empty($preset->preset['id'])) ? $preset->preset['id'] : 'new'); ?>&ref=<?php echo $camera->info['id']; ?>" method="POST" class="form-horizontal">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_NAME; ?><p class='help-block'><small><?php echo IPP_PRESET_NAME_EX; ?></small></p></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_LEFT; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_UP; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_DOWN; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_UPRIGHT; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_UPLEFT; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_DOWNRIGHT; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_DOWNLEFT; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_WIDE; ?><p class='help-block'><small><?php echo IPP_PRESET_WIDE_EX; ?></small></p></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_TIGHT; ?><p class='help-block'><small><?php echo IPP_PRESET_TIGHT_EX; ?></small></p></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_FOCUSIN; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_FOCUSOUT; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_PRESET_SAVE; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_PRESET_GO; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_STOP; ?><p class='help-block'><small><?php echo IPP_PRESET_STOP_EX; ?></small></p></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_NEEDS_STOP; ?><p class='help-block'><small><?php echo IPP_PRESET_NEEDS_STOP_EX; ?></small></p></label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 col-md-4 control-label"><?php echo IPP_PRESET_HTTP_AUTH; ?><p class='help-block'><small><?php echo IPP_PRESET_HTTP_AUTH_EX; ?></small></p></label>
