<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><?php echo MMENU_PLAYBACK; ?></h1>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12" id="playback-results"></div>
</div>

<div class="row">
    <div class="col-md-12" id="playback-player-bl" style="display: none;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div>
                    ...
                    <a href="" class="btn btn-primary" id="playback-player-download-mkv" target="_blank">Download AVI file</a>
                </div>
            </div>
        </div>
    </div>
