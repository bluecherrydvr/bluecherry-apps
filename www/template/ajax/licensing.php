...
<div class="row">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="/licensing?mode=add" method="POST">
...
<div class="row" id="licensing-conf" style="display: none;">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="/licensing?mode=confirm" method="POST">
                <div class="form-group">
        			<input type="hidden" name="licenseCode">
        			<input class="form-control" type="text" name="confirmLicense">
                </div>
                <div class="form-group">
                    <button class="btn btn-success send-req-form" type="submit" data-redirect-success="/licensing"> <?php echo L_CONFIRM; ?></button>
                </div>
            </form>
        </div>
    </div>
    		...
    		<?php foreach($licenses as $license){ ?>
                <tr>
                    ...
                    <td class="col-lg-2 col-md-licensing">
                        <form action="/licensing?mode=delete&license=<?php echo $license['license']; ?>" method="POST" style="display: inline-block;">
                            <button type="submit" class="btn btn-danger send-req-form" data-confirm="<?php echo L_CONFIRM_DELETE; ?>" data-redirect-success="/licensing"><i class="fa fa-times fa-fw"></i> <?php echo L_DELETE; ?></button>
                        </form>
                    </td>
                </tr>
            <?php } ?>
