            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <select name="prefertcp" class="form-control">
                                ...
                                <option value="0" <?php echo ($ipCamera->info['rtsp_rtp_prefer_tcp']==0) ? "selected" : ""; ?>>TCP</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <input class="form-control" type="text" name="hls_window_size" value="<?php echo $ipCamera->info['hls_window_size']; ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <input class="form-control" type="text" name="hls_segment_size" value="<?php echo $ipCamera->info['hls_segment_size']; ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <input class="form-control" type="text" name="hls_segment_duration" value="<?php echo $ipCamera->info['hls_segment_duration']; ?>"  />
                        </div>
                    </div>
