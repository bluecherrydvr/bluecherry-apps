...
CREATE TABLE Devices (
	...
	buffer_prerecording smallint DEFAULT 3,	-- Seconds of pre/post recording for
	...
	schedule varchar(168) NOT NULL DEFAULT 'CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC',			-- Recording schedule
	...
	audio_disabled boolean DEFAULT TRUE,	-- should audio be disabled or not
	debug_level tinyint DEFAULT 0,          -- debug output level; 0 is standard, positive is more verbose. 1 for standard debugging, more to be very loud.
	UNIQUE (device_name),
